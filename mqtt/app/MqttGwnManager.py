...
class MqttGwnManager:
    ...
    def _serialise_device(self, gwn_network: GwnNetwork, gwn_device: GwnDevice, ssids: list[GwnSSID]) -> dict[str, object]:
        return {
            ...
            Constants.LAST_BOOT: str(gwn_device.last_boot),
            ...
            Constants.TEMPERATURE: gwn_device.temperature_c,
            Constants.USED_MEMORY: gwn_device.usedMemory_bytes,
            Constants.CHANNEL_LOAD_2G4: gwn_device.channelload_2g4_percent,
            Constants.CHANNEL_LOAD_6G: gwn_device.channelload_6g_percent,
            Constants.CPU_USAGE: gwn_device.cpuUsage_percent,
            Constants.CHANNEL_LOAD_5G: gwn_device.channelload_5g_percent,
